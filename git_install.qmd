...
- Next na primeira tela (General Public License)

![license](image/license.png)

- Local de instalação: Deixe o padrão e clique em Next.
...
*   `Git Bash Here`
*   `Git GUI Here`
* Deixe todas as outras opções como estão e clique em Next.
...
::: {.callout-important}
#### Evite o Vim!
Por padrão, o Git usa um editor de texto chamado *Vim*, que pode ser muito confuso para quem não está acostumado a sair dele. 
Na tela **"Choosing the default editor used by Git"**, abra o menu suspenso e mude a opção para **Notepad as Git's default editor** Isso facilitará muito a sua vida!
:::
- Clique em **Next**.
